...
- [`Cosmos.Sdk`](https://github.com/CosmosOS/Cosmos/blob/gen3/src/Cosmos.Sdk) - MSBuild SDK orchestration
- [`Cosmos.Build.Patcher`](https://github.com/CosmosOS/Cosmos/blob/gen3/src/Cosmos.Build.Patcher) - IL patching infrastructure
- [`Cosmos.Build.Ilc`](https://github.com/CosmosOS/Cosmos/blob/gen3/src/Cosmos.Build.Ilc) - NativeAOT integration
- [`Cosmos.Build.Asm`](https://github.com/CosmosOS/Cosmos/blob/gen3/src/Cosmos.Build.Asm) - Assembly compilation
- [`Cosmos.Build.CC`](https://github.com/CosmosOS/Cosmos/blob/gen3/src/Cosmos.Build.CC) - C compilation (Clang)
- [`Cosmos.Build.Common`](https://github.com/CosmosOS/Cosmos/blob/gen3/src/Cosmos.Build.Common) - Linking and ISO creation
