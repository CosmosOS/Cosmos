...
; 2.0.x
;LicenseLabel1=Παρακαλώ διαβάστε προσεκτικά τις παρακάτω πληροφορίες πριν συνεχίσετε. Χρησιμοποιήστε την μπάρα κύλισης για να δείτε ολο το κείμενο.
;LicenseLabel2=Αποδέχεστε τους όρους της Αδειας Χρήσης; Αν επιλέξετε οχι η εγκατάσταση θα τερματιστεί. Για να συνεχιστεί η εγκατάσταση πρέπει να αποδέχεστε τους όρους της Αδειας Χρήσης.
...
;4.1.8
;SelectDirLabel2=Το [name] θα εγκατασταθή στον ακόλουθο φάκελο.%n%nΓια συνέχεια πάτα Επόμενο. Αν θέλεις άλλο φάκελο, πάτα Ευρεση.
