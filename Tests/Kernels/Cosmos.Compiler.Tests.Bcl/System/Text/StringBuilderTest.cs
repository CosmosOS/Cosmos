...
namespace Cosmos.Compiler.Tests.Bcl.System
{
    public static class StringBuilderTest
    {
        public static void Execute()
        {
            ...
            //Assert.AreEqual(new string('a', 1024), builder.ToString(), "StringBuilder works with 1024 chars");
            builder.Append(data, 0, 976);
            //Assert.AreEqual(new string('a', 2000), builder.ToString(), "StringBuilder works with 2000 chars");
            builder.Append(data, 24, 524);
            //Assert.AreEqual(new string('a', 2500), builder.ToString(), "StringBuilder works with 2500 chars");
        }
    }
}
