...
namespace Cosmos.Core.Memory.Test
{
    ...
    public class MemoryTests
    {
        ...
        private unsafe void InitVMT()
        {
            VTablesImpl.mTypes = new[]
            {
                new VTable()
                {
                    BaseTypeIdentifier = 0,
                    GCFieldCount = 0,
                    GCFieldOffsets = new Native[0],
                    GCFieldTypes = new Native[0],
                    IsStruct = false,
                    Size = 8
                },
                new VTable()
                {
                    BaseTypeIdentifier = 0,
                    GCFieldCount = 1,
                    GCFieldOffsets = new Native[1]{4},
                    GCFieldTypes = new Native[1]{0},
                    IsStruct = false,
                    Size = 12
                }
            };
