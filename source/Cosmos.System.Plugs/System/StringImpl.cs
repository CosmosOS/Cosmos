...
namespace Cosmos.System.Plugs.System
{
    ...
    public static class StringImpl
    {
        ...
        public static bool StartsWith(this string aThis, string aSubstring, StringComparison aComparison)
        {
        ...
        public static string PadHelper(this string aThis, int totalWidth, char paddingChar, bool isRightPadded)
        {
        ...
        public static string Substring(this string aThis, int startpos)
        {
        ...
        public static string Substring(this string aThis, int startpos, int length)
        {
        ...
        public static string Replace(this string aThis, char oldValue, char newValue)
        {
        ...
        public static int CompareTo(this string aThis, string other)
        {
        ...
        public static int IndexOf(this string aThis, char value, int startIndex, int count)
        {
        ...
        public static char[] ToCharArray(this string aThis)
        {
        ...
        public static int IndexOf(this string aThis, string aSubstring, int aIdx, int aLength, StringComparison aComparison)
        {
        ...
        public static bool Contains(this string aThis, string value)
        {
            Char[] di = aThis.ToCharArray();
        ...
        public static bool EndsWith(this string aThis, string aSubStr, bool aIgnoreCase, CultureInfo aCulture)
        {
            return EndsWith(aThis, aSubStr, StringComparison.CurrentCulture);
        }

        public static bool EndsWith(this string aThis, string aSubStr, StringComparison aComparison)
        {
            Char[] di = aThis.ToCharArray();
        ...
        public static bool Equals(this string aThis, string aThat, StringComparison aComparison)
        {
#warning TODO: implement
        ...
        public static int IndexOf(this string aThis, string aValue)
        {
            return aThis.IndexOf(aValue, 0, aThis.Length, StringComparison.CurrentCulture);
        }

        public static int IndexOfAny(this string aThis, char[] aSeparators, int aStartIndex, int aLength)
        {
            if (aSeparators == null)
            {
        ...
        public static string Insert(this string aThis, int aStartPos, string aValue)
        {
            return aThis.Substring(0, aStartPos) + aValue + aThis.Substring(aStartPos);
        }

        public static int LastIndexOf(this string aThis, char aChar, int aStartIndex, int aCount)
        {
            return LastIndexOfAny(aThis, new[] { aChar }, aStartIndex, aCount);
        }

        public static int LastIndexOfAny(this string aThis, char[] aChars, int aStartIndex, int aCount)
        {
        ...
        public static bool StartsWith(this string aThis, string aSubStr, bool aIgnoreCase, CultureInfo aCulture)
        {
            Char[] di = aThis.ToCharArray();
            Char[] ci = aSubStr.ToCharArray();
        ...
        public static string Remove(this string aThis, int aStart, int aCount)
        {
            return aThis.Substring(0, aStart) + aThis.Substring(aStart + aCount, aThis.Length - (aStart + aCount));
        }

        public static string Replace(this string aThis, string oldValue, string newValue)
        {
        ...
        public static string ToLower(this string aThis, CultureInfo aCulture)
        {
            return ChangeCasing(aThis, 65, 90, 32);
        }

        public static string ToUpper(this string aThis, CultureInfo aCulture)
        {
            return ChangeCasing(aThis, 97, 122, -32);
        }

        public static string ToUpper(this string aThis)
        {
            return ChangeCasing(aThis, 97, 122, -32);
        }
        ...
        public static string ToString(this string aThis)
        {
            return aThis;
        }
        ...
        public static string TrimStart(this char[] aThis, string aSubStr)
        {
            char[] ci = aThis;
            char[] di = aSubStr.ToCharArray();

            if (aThis[0] == (aSubStr.ToCharArray()[0]))
            {
                if (!(aThis.ToString() == aSubStr))
                {
