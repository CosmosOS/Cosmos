...
namespace Cosmos.Hardware.Network.Devices.RTL8139.Register
{
    class ConfigurationRegister1
    {
        ...
        public static ConfigurationRegister1 Load(MemoryAddressSpace aMem)
        {
            return new ConfigurationRegister1(aMem);
        }

        private ConfigurationRegister1(MemoryAddressSpace aMem)
        {
            xMem = aMem;
        }
        ...
        {
            return this.CONFIG1.ToBinary(); //Todo - set to .ToBinary(8) when bug fixed
        }
