...
namespace Microsoft.Samples.Debugging.Native
{
    ...
    public class DumpException : Exception
    {
        ...
        public DumpException(string message, Exception innerException)
    ...
    public class DumpMissingDataException : DumpException
    {
        ...
        public DumpMissingDataException(string message)
            : base(message)
        {
        }

        public DumpMissingDataException(string message, Exception innerException)
            : base(message, innerException)
        {
        }

        protected DumpMissingDataException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
    }
    ...
    public sealed class DumpReader : IDisposable
    {
        internal static class NativeMethods
        {
            ...
            #region minidump exception stuff
            ...
            #endregion minidump exception stuff
        ...
        internal DumpPointer TranslateDescriptor(NativeMethods.MINIDUMP_LOCATION_DESCRIPTOR location)
        {
        ...
        internal DumpPointer TranslateRVA(UInt64 rva)
        {
        ...
        /// <param name="rva">RVA within the dump</param>
        /// <returns>DumpPointer representing RVA.</returns>
        internal DumpPointer TranslateRVA(NativeMethods.RVA rva)
        {
        ...
        /// <param name="rva">RVA within the dump</param>
        /// <returns>DumpPointer representing RVA.</returns>
        internal DumpPointer TranslateRVA(NativeMethods.RVA64 rva)
        {
            return m_base.Adjust(rva.Value);
        }
        ...
        internal String GetString(NativeMethods.RVA rva)
        {
        ...
        /// in the dump</returns>
        internal String GetString(DumpPointer ptr)
        {
            EnsureValid();
        ...
        private uint ReadPartialMemoryInternal(ulong targetRequestStart,
        ...
        private NativeMethods.MinidumpMemoryChunks m_memoryChunks;

        // The backup lookup method for memory that's not in the dump is to try and load the memory
        // from the same file on disk.
        private NativeMethods.LoadedFileMemoryLookups m_mappedFileMemory;
