...
public static class NumberHelper
{
    ...
    public static void WriteNumber(uint aValue, bool aZeroFill) => WriteNumber(aValue, 32, aZeroFill);
    ...
    public static void WriteNumber(uint aValue, int aBits) => WriteNumber(aValue, aBits, true);
