...
public static class ToHexString
{
    ...
    public static string ToHex(this byte n) => ConvertToHex(n, 2);
    ...
    /// <returns>
    ///     String value, right aligned and padded on the left with '0's.
    ///     If aWidth is less then the length of the resulting string, the resulting
    ///     string would not be trimmed.
    /// </returns>
    public static string ToHex(this byte n, int aWidth) => ConvertToHex(n, aWidth);
    ...
    public static string ToHex(this int n) =>
        ConvertToHex((uint)n, 4); //TODO: this cast might throw OverflowException. Better catch it.
    ...
    ///     string would not be trimmed.
    /// </returns>
    public static string ToHex(this int n, int aWidth) => ConvertToHex((uint)n, aWidth);
    ...
    /// <returns>4 characters long string value, padded with '0's.</returns>
    public static string ToHex(this ushort n) => ConvertToHex(n, 4);
    ...
    ///     string would not be trimmed.
    /// </returns>
    public static string ToHex(this ushort n, int aWidth) => ConvertToHex(n, aWidth);
    ...
    public static string ToHex(this uint aValue) => ConvertToHex(aValue, 8);
    ...
    ///     string would not be trimmed.
    /// </returns>
    public static string ToHex(this uint aValue, int aWidth) => ConvertToHex(aValue, aWidth);
    ...
    ///     string would not be trimmed.
    /// </returns>
    public static string ToHex(this ulong aValue, int aWidth) => ConvertToHex(aValue).PadLeft(aWidth, '0');

    /// <summary>
    ///     Get hex prefix.
    /// </summary>
    /// <returns>Hex prefix, as string.</returns>
    private static string GetPrefix() => "0x";

    /// <summary>
    ///     Get hex suffix.
    /// </summary>
    /// <returns>Hex suffix, as string.</returns>
    private static string GetSuffix() => "h";
    ...
    private static string ConvertToHex(uint aValue, int aWidth) =>
        ConvertToHex(aValue)
            .PadLeft(aWidth, '0'); //TODO: PadLeft might throw ArgumentOutOfRangeException. Better catch it.
