...
namespace Cosmos.System.FileSystem.VFS
{
    public static class VFSManager
    {
        ...
        public static void Inittiailze(VFSBase aVFS)
        {
            if (mVFS != null)
            {
        ...
        public static Cosmos.System.FileSystem.Listing.File GetFile(string aPath)
        {
            ...
            foreach (var xEntry in VFSManager.GetDirectoryListing(xDirectory))
            {
        ...
        public static bool DirectoryExists(string aPath)
        {
            try
            {
                string xDir = aPath + Path.DirectorySeparatorChar;
                return (VFSManager.GetDirectory(Path.GetDirectoryName(xDir)) != null);
            }
            catch (Exception)
            {
                return false;
