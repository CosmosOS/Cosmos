...
namespace Indy.IL2CPU {
    public class ReadOnlyDictionary<K, V> : IDictionary<K, V> {
        private readonly IDictionary<K, V> mBackend;

        public ReadOnlyDictionary(IDictionary<K, V> aBackend) {
            mBackend = aBackend;
        }
        ...
        /// <exception cref="T:System.NotSupportedException">The <see cref="T:System.Collections.Generic.ICollection`1" /> is read-only. </exception>
        public void Clear() {
            throw new InvalidOperationException("Cannot clear a read-only Dictionary");
        }
        ...
        public void CopyTo(KeyValuePair<K, V>[] array,
                           int arrayIndex) {
            mBackend.CopyTo(array,
                            arrayIndex);
        }
        ...
        public bool ContainsKey(K key) {
            return mBackend.ContainsKey(key);
        }
        ...
        public bool TryGetValue(K key,
                                out V value) {
            return mBackend.TryGetValue(key,
                                        out value);
        }
        ...
        public V this[K key] {
            ...
            set {
                throw new InvalidOperationException("Cannot change elements in a read-only Dictionary");
            }
        }
