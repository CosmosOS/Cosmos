...
namespace Cosmos.VS.ProjectSystem
{
  ...
  public sealed class VSProject : ProjectPackage, IVsInstalledProduct {
    ...
    public VSProject() {
      LogUtility.LogString("Cosmos.VS.ProjectSystem.VSProject instantiated");
    }
    ...
    protected override void Initialize() {
      LogUtility.LogString("Cosmos.VS.ProjectSystem initializing");
      try {
        SetCosmosVar();
        base.Initialize();
        this.RegisterProjectFactory(new VSProjectFactory(this));
        LogUtility.LogString("Cosmos.VS.ProjectSystem successfully initialized");
      }
      catch (Exception E) {
