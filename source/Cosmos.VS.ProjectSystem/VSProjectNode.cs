...
namespace Cosmos.VS.ProjectSystem {
  public class VSProjectNode : ProjectNode {
    ...
    public VSProjectNode(VSProject package) {
      LogUtility.LogString("Entering Cosmos.VS.ProjectSystem.VSProjectNode.ctor(VSProject)");
      try {
        ...
        LogUtility.LogString("Exiting Cosmos.VS.ProjectSystem.VSProjectNode.ctor(VSProject)");
      }
    }
    ...
    static VSProjectNode() {
      imageList = Utilities.GetImageList(typeof(VSProjectNode).Assembly.GetManifestResourceStream("Cosmos.VS.ProjectSystem.Resources.CosmosProjectNode.bmp"));
    }
    ...
    public override void AddFileFromTemplate(
      ...
      LogUtility.LogString("Entering Cosmos.VS.ProjectSystem.VSProjectNode.AddFileFromTemplate('{0}', '{1}')", source, target);
      try {
        string nameSpace =
        ...
        LogUtility.LogString("Exiting Cosmos.VS.ProjectSystem.VSProjectNode.AddFileFromTemplate");
      }
    }
  }
}
