...
namespace Cosmos.VS.Package
{
    ...
    public partial class CosmosPage : CustomPropertyPage
    {
        ...
        private void butnProfileRename_Click(object sender, EventArgs e)
        {
        ...
        private void butnProfileDelete_Click(object sender, EventArgs e)
        {
            var xItem = (ProfileItem)lboxProfile.SelectedItem;
        ...
        private void butnProfileClone_Click(object sender, EventArgs e)
        {
            var xItem = (ProfileItem)lboxProfile.SelectedItem;
            if (xItem == null)
            {
