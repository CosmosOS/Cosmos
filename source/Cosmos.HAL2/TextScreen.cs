...
public class TextScreen : TextScreenBase
{
    ...
    {
        IO.Memory = new MemoryBlock(0xB8000, (uint)(Cols * Rows * 2));
        mRAM = IO.Memory.Bytes;
        mScrollSize = (uint)(Cols * (Rows - 1) * 2);
        mRow2Addr = (uint)(Cols * 2);
    }
    ...
    public override byte GetColor() => Color;

    /// <summary>
    ///     Get cursor size.
    /// </summary>
    /// <returns>int value.</returns>
    public override int GetCursorSize() => mCursorSize;
    ...
    public override bool GetCursorVisible() => mCursorVisible;
