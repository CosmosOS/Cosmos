...
public class SATA : StoragePort
{
    ...
    internal static Debugger mSATADebugger = new("HAL", "SATA");
    ...
    public SATA(PortRegisters aSATAPort)
    {
        ...
        SendSATA28Command(0x00, 0, 0);
        var xBuffer = new ushort[256];
    ...
    public void SendSATACommand(ATACommands aCommand)
    {
        ...
        var DataBaseAddress = Mem.DataBlock.Base;
    ...
    protected string GetString(ushort[] aBuffer, int aIndexStart, int aStringLength)
    {
        ...
        for (var i = 0; i < aStringLength / 2; i++)
        {
            var xChar = aBuffer[aIndexStart + i];
