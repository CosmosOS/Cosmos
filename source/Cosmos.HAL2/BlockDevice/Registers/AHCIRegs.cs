...
{
    private readonly MemoryBlock xBlock;
...
public class PortRegisters
{
    ...
    public uint Reserved => xBlock[0x1C];
...
public class HBACommandHeader
{
    ...
    public byte CFL
    {
        get => (byte)(xBlock.Bytes[0x00] & 0x1F);
        set => xBlock.Bytes[0x00] = value;
    }

    public byte ATAPI
    {
        get => (byte)((xBlock.Bytes[0x00] >> 5) & 1);
        set => xBlock.Bytes[0x00] |= (byte)(value << 5);
    }

    public byte Write
    {
        get => (byte)((xBlock.Bytes[0x00] >> 6) & 1);
        set => xBlock.Bytes[0x00] |= (byte)(value << 6);
    }

    public byte Prefetchable
    {
        get => (byte)((xBlock.Bytes[0x00] >> 7) & 1);
        set => xBlock.Bytes[0x00] |= (byte)(value << 7);
    }

    public byte Reset
    {
        get => (byte)(xBlock.Bytes[0x01] & 1);
        set => xBlock.Bytes[0x01] |= value;
    }

    public byte BIST
    {
        get => (byte)((xBlock.Bytes[0x01] >> 1) & 1);
        set => xBlock.Bytes[0x01] |= (byte)(value << 1);
    }

    public byte ClearBusy
    {
        get => (byte)((xBlock.Bytes[0x01] >> 2) & 1);
        set => xBlock.Bytes[0x01] |= (byte)(value << 2);
    }

    public byte Reserved => (byte)((xBlock.Bytes[0x01] >> 3) & 1);

    public byte PMP
    {
        get => (byte)((xBlock.Bytes[0x01] >> 4) & 0x0F);
        set => xBlock.Bytes[0x01] = (byte)(value << 4);
    }

    public ushort PRDTL
    {
        get => xBlock.Words[0x02];
    ...
    public uint Reserved1 => xBlock[0x10];

    public uint Reserved2 => xBlock[0x14];

    public uint Reserved3 => xBlock[0x18];

    public uint Reserved4 => xBlock[0x1C];
}
...
public class HBACommandTable
{
    ...
    public uint Reserved => xBlock[0x50];
}

public class HBAPRDTEntry
{
    private readonly MemoryBlock xBlock;
    private readonly uint xEntry;
    private uint xAddress;
    ...
    public uint Reserved => xBlock[0x08];

    public uint DBC
    {
        get => xBlock[0x0C] & 0x3FFFFF;
        set => xBlock[0x0C] = value;
    }

    public uint Reserved1 => xBlock[0x0E] << 6;

    public byte InterruptOnCompletion
    {
        get => (byte)(xBlock.Bytes[0x0F] >> 7);
...
public class FISRegisterH2D
{
    ...
    public byte FISType
    {
        get => xBlock.Bytes[0x00];
        set => xBlock.Bytes[0x00] = value;
    }

    public byte IsCommand
    {
        get => (byte)(xBlock.Bytes[0x01] >> 7);
        set => xBlock.Bytes[0x01] = (byte)(value << 7);
    }

    public byte Command
    {
        get => xBlock.Bytes[0x02];
        set => xBlock.Bytes[0x02] = value;
    }

    public byte FeatureLow
    {
        get => xBlock.Bytes[0x03];
        set => xBlock.Bytes[0x03] = value;
    }

    public byte LBA0
    {
        get => xBlock.Bytes[0x04];
        set => xBlock.Bytes[0x04] = value;
    }

    public byte LBA1
    {
        get => xBlock.Bytes[0x05];
        set => xBlock.Bytes[0x05] = value;
    }

    public byte LBA2
    {
        get => xBlock.Bytes[0x06];
        set => xBlock.Bytes[0x06] = value;
    }

    public byte Device
    {
        get => xBlock.Bytes[0x07];
        set => xBlock.Bytes[0x07] = value;
    }

    public byte LBA3
    {
        get => xBlock.Bytes[0x08];
        set => xBlock.Bytes[0x08] = value;
    }

    public byte LBA4
    {
        get => xBlock.Bytes[0x09];
        set => xBlock.Bytes[0x09] = value;
    }

    public byte LBA5
    {
        get => xBlock.Bytes[0x0A];
        set => xBlock.Bytes[0x0A] = value;
    }

    public byte FeatureHigh
    {
        get => xBlock.Bytes[0x0B];
        set => xBlock.Bytes[0x0B] = value;
    }

    public byte CountL
    {
        get => xBlock.Bytes[0x0C];
        set => xBlock.Bytes[0x0C] = value;
    }

    public byte CountH
    {
        get => xBlock.Bytes[0x0D];
        set => xBlock.Bytes[0x0D] = value;
    }

    public byte ICC
    {
        get => xBlock.Bytes[0x0E];
        set => xBlock.Bytes[0x0E] = value;
    }

    public byte Control
    {
        get => xBlock.Bytes[0x0F];
        set => xBlock.Bytes[0x0F] = value;
    }

    public byte Reserved1 => xBlock.Bytes[0x10];

    public byte Reserved2 => xBlock.Bytes[0x11];

    public byte Reserved3 => xBlock.Bytes[0x12];

    public byte Reserved4 => xBlock.Bytes[0x13];
}
...
public class FISRegisterD2H
{
    ...
    {
        get => (FISType)xBlock.Bytes[0x00];
        set => xBlock.Bytes[0x00] = (byte)value;
    }

    public byte PortMultiplier
    {
        get => (byte)(xBlock.Bytes[0x00] << 8);
        set => xBlock.Bytes[0x00] = value;
    }

    public byte Reserved => (byte)(xBlock.Bytes[0x00] << 12);

    public byte InterruptBit
    {
        get => (byte)(xBlock.Bytes[0x00] << 14);
        set => xBlock.Bytes[0x00] = (byte)(value << 14);
    }

    public byte Reserved1 => (byte)(xBlock.Bytes[0x00] << 15);

    public byte Status
    {
        get => (byte)(xBlock.Bytes[0x00] << 16);
        set => xBlock.Bytes[0x00] = (byte)(value << 16);
    }

    public byte Error
    {
        get => (byte)(xBlock.Bytes[0x00] << 24);
    ...
    public byte LBA1
    {
        get => (byte)(xBlock.Bytes[0x04] << 8);
        set => xBlock.Bytes[0x04] = (byte)(value << 8);
    }

    public byte LBA2
    {
        get => (byte)(xBlock.Bytes[0x04] << 16);
        set => xBlock.Bytes[0x04] = (byte)(value << 16);
    }

    public byte Device
    {
        get => (byte)(xBlock.Bytes[0x04] << 24);
    ...
    public byte LBA4
    {
        get => (byte)(xBlock.Bytes[0x08] << 8);
        set => xBlock.Bytes[0x08] = (byte)(value << 8);
    }

    public byte LBA5
    {
        get => (byte)(xBlock.Bytes[0x08] << 16);
        set => xBlock.Bytes[0x08] = (byte)(value << 16);
    }

    public byte Reserved2 => (byte)(xBlock.Bytes[0x08] << 24);
    ...
    public byte CountH
    {
        get => (byte)(xBlock.Bytes[0x0C] << 8);
        set => xBlock.Bytes[0x0C] = (byte)(value << 8);
    }

    public byte Reserved3 => (byte)(xBlock.Bytes[0x0C] << 16);

    public byte Reserved4 => (byte)(xBlock.Bytes[0x0C] << 24);

    public byte Reserved5 => xBlock.Bytes[0x10];

    public byte Reserved6 => xBlock.Bytes[0x11];

    public byte Reserved7 => xBlock.Bytes[0x12];

    public byte Reserved8 => xBlock.Bytes[0x13];
}
