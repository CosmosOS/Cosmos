...
{
    public static uint MsToHz(this int ms) => (uint)(1000 / ms);
...
public class PCSpeaker
{
    ...
    ///     Enable sound.
    /// </summary>
    private static void EnableSound() => IO.Gate.Byte = (byte)(IO.Gate.Byte | 0x03);

    /// <summary>
    ///     Disable sound.
    /// </summary>
    private static void DisableSound() => IO.Gate.Byte = (byte)(IO.Gate.Byte & ~3);
