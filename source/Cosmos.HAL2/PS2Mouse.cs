...
{
    private static byte mMouseCycle;

    private readonly Core.IOGroup.PS2Controller IO = Core.Global.BaseIOGroups.PS2Controller;
    private readonly Debugger mDebugger = new("HAL", "PS2Mouse");

    private readonly byte[] mMouseByte = new byte[4];
    private readonly PS2Controller mPS2Controller = Global.PS2Controller;

    private byte mMouseID;
