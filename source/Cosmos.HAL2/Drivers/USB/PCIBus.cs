...
namespace Cosmos.HAL.USB
{
    ...
    public abstract class PCIDevice
    {
        ...
        private void LayoutIO()
        {
            ...
            IOMaps = new HAL.USB.AddressSpace[NumberOfBaseAddresses()];
            ...
            for (byte i = 0; i < NumberOfBaseAddresses(); i++)
            {
                ...
                else if ((address & PCI_BASE_ADDRESS_SPACE) == PCI_BASE_ADDRESS_SPACE_IO)
                {
                    ...
                    IOMaps[i] = new IOAddressSpace(address - 1, ((uint)size));
                    NeedsIO = true;
                }
            }
        ...
        {
            CPUBus.Write32(ConfigAddr, GetAddress(aRegister));
            return (UInt16)(CPUBus.Read32(ConfigData) >> ((aRegister % 4) * 8) & 0xFFFF);
        }

        protected byte Read8(byte aRegister)
        {
            CPUBus.Write32(ConfigAddr, GetAddress(aRegister));
            return (byte)(CPUBus.Read32(ConfigData) >> ((aRegister % 4) * 8) & 0xFF);
        }
