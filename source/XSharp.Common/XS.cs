...
namespace XSharp.Common
{
  ...
  public static partial class XS
  {
    ...
    public static void MoveSignExtend(Register destination, Register source, bool sourceIsIndirect = false, int? sourceDisplacement = null, RegisterSize? size = null)
    {
      Do<MoveSignExtend>(destination, source, false, null, sourceIsIndirect, sourceDisplacement, true, size);
    }

    public static void MoveSignExtend(Register destination, string sourceLabel, int? sourceDisplacement = null, RegisterSize? size = null)
    {
      Do<MoveSignExtend>(destination, sourceLabel, false, null, true, sourceDisplacement, size);
    }

    public static void MoveSignExtend(Register destination, uint sourceValue, RegisterSize? size = null)
    {
      Do<MoveSignExtend>(destination, sourceValue, false, null, false, null, size);
    }
    ...
    public static void MoveZeroExtend(Register destination, Register source, bool sourceIsIndirect = false, int? sourceDisplacement = null, RegisterSize? size = null)
    {
      Do<MoveZeroExtend>(destination, source, false, null, sourceIsIndirect, sourceDisplacement, true, size);
    }

    public static void MoveZeroExtend(Register destination, string sourceLabel, int? sourceDisplacement = null, RegisterSize? size = null)
    {
      Do<MoveZeroExtend>(destination, sourceLabel, false, null, true, sourceDisplacement, size);
    }

    public static void MoveZeroExtend(Register destination, uint sourceValue, RegisterSize? size = null)
    {
      Do<MoveZeroExtend>(destination, sourceValue, false, null, false, null, size);
    }
