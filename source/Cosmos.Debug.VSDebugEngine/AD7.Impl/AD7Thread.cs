...
namespace Cosmos.Debug.VSDebugEngine
{
    ...
    public class AD7Thread : IDebugThread2
    {
        ...
        private const string ThreadNameString = "Cosmos Kernel Main Thread";

        public AD7Thread(AD7Engine aEngine, AD7Process aProcess)
        ...
        #endregion IDebugThread2 Members
        ...
        #endregion Uncalled interface methods
    }
}