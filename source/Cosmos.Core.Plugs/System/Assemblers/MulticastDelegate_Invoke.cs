...
namespace Cosmos.Core.Plugs.System.Assemblers
{
    public class MulticastDelegate_Invoke : AssemblerMethod
    {
        ...
        public override void AssembleNew(Assembler.Assembler aAssembler, object aMethodInfo)
        {
            ...
            new Comment("edi = ptr to delegate object");
            new CPUx86.Mov { DestinationReg = CPUx86.Registers.EDI, SourceReg = CPUx86.Registers.EBP, SourceIsIndirect = true, SourceDisplacement = Cosmos.IL2CPU.X86.IL.Ldarg.GetArgumentDisplacement(xMethodInfo, 0) };
            new Comment("edi = ptr to delegate object should be a pointer to the delgates context ie (this) for the methods ");
