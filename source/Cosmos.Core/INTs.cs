...
public class INTs
{
    ...
    private static readonly uint mLastKnownAddress = 0;

    /// <summary>
    ///     IRQ handlers.
    /// </summary>
    private static readonly IRQDelegate[] mIRQ_Handlers = new IRQDelegate[256];
    ...
    public static void SetIntHandler(byte aIntNo, IRQDelegate aHandler) => mIRQ_Handlers[aIntNo] = aHandler;
    ...
    public struct TSS
    {
        ...
        ///     Reserved.
        /// </summary>
        [FieldOffset(0)] public ushort Link;

        [FieldOffset(4)] public uint ESP0;

        /// <summary>
        ///     Reserved.
        /// </summary>
        [FieldOffset(8)] public ushort SS0;

        [FieldOffset(12)] public uint ESP1;

        /// <summary>
        ///     Reserved.
        /// </summary>
        [FieldOffset(16)] public ushort SS1;

        [FieldOffset(20)] public uint ESP2;

        /// <summary>
        ///     Reserved.
        /// </summary>
        [FieldOffset(24)] public ushort SS2;

        [FieldOffset(28)] public uint CR3;
        [FieldOffset(32)] public uint EIP;
        [FieldOffset(36)] public EFlagsEnum EFlags;
        [FieldOffset(40)] public uint EAX;
        [FieldOffset(44)] public uint ECX;
        [FieldOffset(48)] public uint EDX;
        [FieldOffset(52)] public uint EBX;
        [FieldOffset(56)] public uint ESP;
        [FieldOffset(60)] public uint EBP;
        [FieldOffset(64)] public uint ESI;
        [FieldOffset(68)] public uint EDI;

        /// <summary>
        ///     Reserved.
        /// </summary>
        [FieldOffset(72)] public ushort ES;

        /// <summary>
        ///     Reserved.
        /// </summary>
        [FieldOffset(76)] public ushort CS;

        /// <summary>
        ///     Reserved.
        /// </summary>
        [FieldOffset(80)] public ushort SS;

        /// <summary>
        ///     Reserved.
        /// </summary>
        [FieldOffset(84)] public ushort DS;

        /// <summary>
        ///     Reserved.
        /// </summary>
        [FieldOffset(88)] public ushort FS;

        /// <summary>
        ///     Reserved.
        /// </summary>
        [FieldOffset(92)] public ushort GS;

        /// <summary>
        ///     Reserved.
        /// </summary>
        [FieldOffset(96)] public ushort LDTR;

        /// <summary>
        ///     Reserved.
        /// </summary>
        [FieldOffset(102)] public ushort IOPBOffset;
    }
    ...
    {
        [FieldOffset(0)] public unsafe MMXContext* MMXContext;

        [FieldOffset(4)] public uint EDI;

        [FieldOffset(8)] public uint ESI;

        [FieldOffset(12)] public uint EBP;

        [FieldOffset(16)] public uint ESP;

        [FieldOffset(20)] public uint EBX;

        [FieldOffset(24)] public uint EDX;

        [FieldOffset(28)] public uint ECX;

        [FieldOffset(32)] public uint EAX;

        [FieldOffset(36)] public uint Interrupt;

        [FieldOffset(40)] public uint Param;

        [FieldOffset(44)] public uint EIP;

        [FieldOffset(48)] public uint CS;

        [FieldOffset(52)] public EFlagsEnum EFlags;

        [FieldOffset(56)] public uint UserESP;
    }
    ...
    public static void HandleInterrupt_40(ref IRQContext aContext) => IRQ(0x40, ref aContext);

    public static void HandleInterrupt_41(ref IRQContext aContext) => IRQ(0x41, ref aContext);

    public static void HandleInterrupt_42(ref IRQContext aContext) => IRQ(0x42, ref aContext);

    public static void HandleInterrupt_43(ref IRQContext aContext) => IRQ(0x43, ref aContext);

    public static void HandleInterrupt_44(ref IRQContext aContext) => IRQ(0x44, ref aContext);

    public static void HandleInterrupt_45(ref IRQContext aContext) => IRQ(0x45, ref aContext);

    public static void HandleInterrupt_46(ref IRQContext aContext) => IRQ(0x46, ref aContext);

    public static void HandleInterrupt_47(ref IRQContext aContext) => IRQ(0x47, ref aContext);

    public static void HandleInterrupt_48(ref IRQContext aContext) => IRQ(0x48, ref aContext);

    public static void HandleInterrupt_49(ref IRQContext aContext) => IRQ(0x49, ref aContext);
    ...
    /// <exception cref="System.IndexOutOfRangeException">Thrown on fatal error, contact support.</exception>
    /// <exception cref="System.OverflowException">Thrown on fatal error, contact support.</exception>
    public static void HandleInterrupt_00(ref IRQContext aContext) => HandleException(aContext.EIP, "Divide by zero",
        "EDivideByZero", ref aContext, aContext.EIP);
    ...
    public static void HandleInterrupt_02(ref IRQContext aContext) =>
        HandleException(aContext.EIP, "Non Maskable Interrupt Exception", "Non Maskable Interrupt Exception",
            ref aContext);
    ...
    /// <exception cref="System.IndexOutOfRangeException">Thrown on fatal error, contact support.</exception>
    /// <exception cref="System.OverflowException">Thrown on fatal error, contact support.</exception>
    public static void HandleInterrupt_03(ref IRQContext aContext) => HandleException(aContext.EIP,
        "Breakpoint Exception", "Breakpoint Exception", ref aContext);
    ...
    public static void HandleInterrupt_04(ref IRQContext aContext) =>
        HandleException(aContext.EIP, "Into Detected Overflow Exception", "Into Detected Overflow Exception",
            ref aContext);
    ...
    /// <exception cref="System.IndexOutOfRangeException">Thrown on fatal error, contact support.</exception>
    /// <exception cref="System.OverflowException">Thrown on fatal error, contact support.</exception>
    public static void HandleInterrupt_05(ref IRQContext aContext) => HandleException(aContext.EIP,
        "Out of Bounds Exception", "Out of Bounds Exception", ref aContext);
    ...
    /// <exception cref="System.IndexOutOfRangeException">Thrown on fatal error, contact support.</exception>
    /// <exception cref="System.OverflowException">Thrown on fatal error, contact support.</exception>
    public static void HandleInterrupt_07(ref IRQContext aContext) => HandleException(aContext.EIP,
        "No Coprocessor Exception", "No Coprocessor Exception", ref aContext);
    ...
    /// <exception cref="System.IndexOutOfRangeException">Thrown on fatal error, contact support.</exception>
    /// <exception cref="System.OverflowException">Thrown on fatal error, contact support.</exception>
    public static void HandleInterrupt_08(ref IRQContext aContext) => HandleException(aContext.EIP,
        "Double Fault Exception", "Double Fault Exception", ref aContext);
    ...
    public static void HandleInterrupt_09(ref IRQContext aContext) =>
        HandleException(aContext.EIP, "Coprocessor Segment Overrun Exception",
            "Coprocessor Segment Overrun Exception", ref aContext);
    ...
    /// <exception cref="System.IndexOutOfRangeException">Thrown on fatal error, contact support.</exception>
    /// <exception cref="System.OverflowException">Thrown on fatal error, contact support.</exception>
    public static void HandleInterrupt_0B(ref IRQContext aContext) => HandleException(aContext.EIP,
        "Segment Not Present", "Segment Not Present", ref aContext);
    ...
    /// <exception cref="System.IndexOutOfRangeException">Thrown on fatal error, contact support.</exception>
    /// <exception cref="System.OverflowException">Thrown on fatal error, contact support.</exception>
    public static void HandleInterrupt_0C(ref IRQContext aContext) => HandleException(aContext.EIP,
        "Stack Fault Exception", "Stack Fault Exception", ref aContext);
    ...
    /// <exception cref="System.IndexOutOfRangeException">Thrown on fatal error, contact support.</exception>
    /// <exception cref="System.OverflowException">Thrown on fatal error, contact support.</exception>
    public static void HandleInterrupt_0E(ref IRQContext aContext) => HandleException(aContext.EIP,
        "Page Fault Exception", "Page Fault Exception", ref aContext);
    ...
    /// <exception cref="System.IndexOutOfRangeException">Thrown on fatal error, contact support.</exception>
    /// <exception cref="System.OverflowException">Thrown on fatal error, contact support.</exception>
    public static void HandleInterrupt_0F(ref IRQContext aContext) => HandleException(aContext.EIP,
        "Unknown Interrupt Exception", "Unknown Interrupt Exception", ref aContext);
    ...
    /// <exception cref="System.IndexOutOfRangeException">Thrown on fatal error, contact support.</exception>
    /// <exception cref="System.OverflowException">Thrown on fatal error, contact support.</exception>
    public static void HandleInterrupt_10(ref IRQContext aContext) => HandleException(aContext.EIP,
        "x87 Floating Point Exception", "Coprocessor Fault Exception", ref aContext);
    ...
    /// <exception cref="System.IndexOutOfRangeException">Thrown on fatal error, contact support.</exception>
    /// <exception cref="System.OverflowException">Thrown on fatal error, contact support.</exception>
    public static void HandleInterrupt_11(ref IRQContext aContext) => HandleException(aContext.EIP,
        "Alignment Exception", "Alignment Exception", ref aContext);
    ...
    /// <exception cref="System.IndexOutOfRangeException">Thrown on fatal error, contact support.</exception>
    /// <exception cref="System.OverflowException">Thrown on fatal error, contact support.</exception>
    public static void HandleInterrupt_12(ref IRQContext aContext) => HandleException(aContext.EIP,
        "Machine Check Exception", "Machine Check Exception", ref aContext);
    ...
    public static void HandleInterrupt_13(ref IRQContext aContext) =>
        HandleException(aContext.EIP, "SIMD Floating Point Exception", "SIMD Floating Point Exception",
            ref aContext);
