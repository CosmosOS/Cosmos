...
public class MemoryBlock
{
    ...
    //TODO: Make an attribute that can be applied to methods to tell the compiler to inline them to save
    ...
    public unsafe void Fill(uint aByteOffset, uint aCount, uint aData)
    {
        ...
        var xDest = (uint*)(Base + aByteOffset);
    ...
    {
        // TODO throw exception if aStart and aCount are not in bound. I've tried to do this but Bochs dies :-(
        var xDest = (int*)(Base + aByteOffset);
    ...
    public void Fill(byte aData) => Fill(0, Size, aData);

    /// <summary>
    ///     Fill data to memory block.
    /// </summary>
    /// <param name="aData">Data to fill the memory block with.</param>
    public void Fill(ushort aData) => Fill(0, Size, aData);
    ...
    {
        // TODO throw exception if aStart and aCount are not in bound. I've tried to do this but Bochs dies :-(
        var xDest = (ushort*)(Base + aByteOffset);
        MemoryOperations.Fill(xDest, aData, (int)aCount);
    }
    ...
    {
        // TODO throw exception if aStart and aCount are not in bound. I've tried to do this but Bochs dies :-(
        var xDest = (byte*)(Base + aByteOffset);
        MemoryOperations.Fill(xDest, aData, (int)aCount);
    }
    ...
    [DebugStub(Off = true)]
    public void Copy(uint[] aData) => Copy(0, aData, 0, aData.Length);
    ...
    public unsafe void Copy(uint aByteOffset, uint[] aData, int aIndex, int aCount)
    {
        // TODO throw exception if aStart and aCount are not in bound. I've tried to do this but Bochs dies :-(
        var xDest = (uint*)(Base + aByteOffset);
    ...
    {
        var xDest = (byte*)Base;
        var aDataPtr = (byte*)block.Offset;
    ...
    public void MoveUp(uint aDest, uint aSrc, uint aCount) => throw new Exception("TODO");
    ...
    {
        var xDest = (uint*)(Base + aStart);
        var array = new uint[aCount];
    ...
    /// </summary>
    /// <returns>uint array.</returns>
    public uint[] ToArray() => ToArray(0, 0, (int)Size);
