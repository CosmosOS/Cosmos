...
public abstract class IOPortBase
{
    ...
    protected static void Write8(ushort aPort, byte aData) => throw null;
    ...
    /// <param name="aData">A data.</param>
    [PlugMethod(PlugRequired = true)]
    protected static void Write16(ushort aPort, ushort aData) => throw null;
    ...
    /// <param name="aData">A data.</param>
    [PlugMethod(PlugRequired = true)]
    protected static void Write32(ushort aPort, uint aData) => throw null;
    ...
    [PlugMethod(PlugRequired = true)]
    protected static byte Read8(ushort aPort) => throw null;
    ...
    [PlugMethod(PlugRequired = true)]
    protected static ushort Read16(ushort aPort) => throw null;
    ...
    [PlugMethod(PlugRequired = true)]
    protected static uint Read32(ushort aPort) => throw null;
