...
public class PIC
{
    ...
    ///     Master PIC.
    /// </summary>
    protected IOGroup.PIC Master = new(false);

    /// <summary>
    ///     Slave PIC.
    /// </summary>
    protected IOGroup.PIC Slave = new(true);
    ...
    /// </summary>
    public void EoiMaster() => Master.Cmd.Byte = (byte)Cmd.EOI;
