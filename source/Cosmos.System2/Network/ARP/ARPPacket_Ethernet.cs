...
internal abstract class ARPPacket_Ethernet : ARPPacket
{
    ...
    ///     Get sender MAC.
    /// </summary>
    internal MACAddress SenderMAC => mSenderMAC;

    /// <summary>
    ///     Get target MAC.
    /// </summary>
    internal MACAddress TargetMAC => mTargetMAC;

    /// <summary>
    ///     Get sender IP.
    /// </summary>
    internal Address SenderIP => mSenderIP;

    /// <summary>
    ///     Get target IP.
    /// </summary>
    internal Address TargetIP => mTargetIP;
    ...
    public override string ToString() =>
        "IPv4 Ethernet ARP Packet SenderMAC=" + mSenderMAC + ", TargetMAC=" + mTargetMAC + ", SenderIP=" + mSenderIP +
...
internal class ARPReply_Ethernet : ARPPacket_Ethernet
{
    ...
    /// </summary>
    /// <returns>string value.</returns>
    public override string ToString() => "ARP Reply Src=" + srcMAC + ", Dest=" + destMAC + ", Sender=" + mSenderIP +
                                         ", Target=" + mTargetIP;
}
...
internal class ARPRequest_Ethernet : ARPPacket_Ethernet
{
    ...
    /// </summary>
    /// <returns>string value.</returns>
    public override string ToString() => "ARP Request Src=" + srcMAC + ", Dest=" + destMAC + ", Sender=" + mSenderIP +
                                         ", Target=" + mTargetIP;
}
