...
public class UdpClient : IDisposable
{
    ...
    ///     Clients dictionary.
    /// </summary>
    private static readonly Dictionary<uint, UdpClient> clients;
    ...
    {
        var source = IPConfig.FindNetwork(dest);
    ...
    /// <exception cref="Sys.IO.IOException">Thrown on IO error.</exception>
    internal void ReceiveData(UDPPacket packet) => rxBuffer.Enqueue(packet);
}
