...
public static class PCSExtensions
{
    ...
    public static uint MsToHz(this int ms) => (uint)(1000 / ms); //TODO: maybe throw exception on <= 0 ms value
    ...
    /// <param name="ms">A milliseconds value, must be > 0.</param>
    /// <returns>integer value.</returns>
    public static uint MsToHz(this uint ms) => 1000 / ms;
}
...
public class PCSpeaker
{
    ...
    /// </summary>
    public static void Beep() => Beep((uint)Notes.Default, (uint)Durations.Default);
    ...
    public static void Beep(uint frequency) => Beep(frequency, (uint)Durations.Default);
    ...
    public static void Beep(uint frequency, uint duration) => HAL.PCSpeaker.Beep(frequency, duration);
    ...
    /// <param name="duration">Beep duration, must be > 0.</param>
    public static void Beep(Notes note, Durations duration) => Beep((uint)note, (uint)duration);
    ...
    /// </summary>
    /// <param name="note">A note to play.</param>
    public static void Beep(Notes note) => Beep((uint)note, (uint)Durations.Default);
}
