...
public static class Power
{
    ...
    ///     Reboot with CPU.
    /// </summary>
    public static void Reboot() => HAL.Power.CPUReboot();

    /// <summary>
    ///     Shutdown the ACPI.
    /// </summary>
    /// <exception cref="sysIO.IOException">Thrown on IO error.</exception>
    public static void Shutdown() => HAL.Power.ACPIShutdown();
    ...
    /// </summary>
    public static void QemuShutdown() => new IOPort(0x604).Word = 0x2000;
    ...
    /// </summary>
    public static void QemuReboot() => new IOPort(0x64).Byte = 0xFE;
}
