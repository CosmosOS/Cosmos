...
public class ISO9660FileSystem : FileSystem
{
    ...
    private readonly ISO9660Directory RootDir;
        ...
        : base(aDevice, aRootPath, aSize)
    {
        ...
        var rootdir = new BinaryReader(new MemoryStream(b));
    ...
    {
        get => label;
        set => throw new NotImplementedException("Read only file system");
    }
    ...
    private ISO9660Directory ReadDirectoryEntry(BinaryReader lba)
    {
        ...
        var rv = new byte[locofextbytesPT1.Length + locofextbytesPT2.Length];
        ...
        var rv2 = new byte[sizePT1.Length + sizePT2.Length];
    ...
    internal byte[] ReadFile(ISO9660Directory entry)
    {
        ...
        while (true)
        {
            ...
            {
                for (var i = 0; i < entry.FileSize; i++)
                {
    ...
    public override void DisplayFileSystemInfo() => global::System.Console.WriteLine("Volume label is " + label);
    ...
    public override List<DirectoryEntry> GetDirectoryListing(DirectoryEntry baseDirectory)
    {
        ...
        var parent = new ISO9660DirectoryEntry(baseEntry.internalEntry, this, baseEntry, baseDirectory.mFullPath, ".",
            0, DirectoryEntryTypeEnum.Directory);
        foreach (var item in dirEntries)
        {
            ...
            entries.Add(new ISO9660DirectoryEntry(item, this, parent, Path.Combine(parent.mFullPath, properID),
                properID, 0, type));
        }
    ...
    public override DirectoryEntry GetRootDirectory() => new ISO9660DirectoryEntry(RootDir, this, null, RootPath,
        RootPath, 0, DirectoryEntryTypeEnum.Directory);
    ...
    public override void DeleteFile(DirectoryEntry aPath) => throw new NotImplementedException("Read only file system");

    public override void Format(string aDriveFormat, bool aQuick) => throw new NotImplementedException();
