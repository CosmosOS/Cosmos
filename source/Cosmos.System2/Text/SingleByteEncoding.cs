...
internal class SingleByteEncoding : Encoding
{
    ...
    /// </summary>
    private static readonly Debugger mDebugger = new("System", "SingleByteEncoding");
    ...
    private byte GetByte(char ch)
    {
        ...
        var idx = GetCodePageIdxFromChr(ch);
        if (idx == -1)
        {
    ...
    ///     Thrown if bytes array length or codepage table length is greater than
    ///     Int32.MaxValue.
    /// </exception>
