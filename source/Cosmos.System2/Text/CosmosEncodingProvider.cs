...
/// <summary>
///     CosmosEncodingProvider class. Used to provide <see cref="Encoder" />, by using its name or codepage. See also:
///     <seealso cref="EncodingProvider" />.
/// </summary>
public class CosmosEncodingProvider : EncodingProvider
{
    ...
    /// </summary>
    private static readonly Debugger myDebugger = new("System", "CosmosEncodingProvider");
    ...
    public override Encoding GetEncoding(string name)
    {
        ...
        var codepage = EncodingTable.GetCodePageFromDesc(name);
        if (codepage == -1)
        {
            return null;
        }
