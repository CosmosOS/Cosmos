...
public static class Global
{
    ...
    public static void Init(TextScreenBase textScreen, bool InitScroolWheel = true, bool InitPS2 = true,
        bool InitNetwork = true, bool IDEInit = true)
    {
    ...
    public static void ChangeKeyLayout(ScanMapBase scanMap) => KeyboardManager.SetKeyLayout(scanMap);
}
