...
namespace Cosmos.System
{
    ...
    public static class Global
    {
        ...
        public static void Init(TextScreenBase textScreen, bool InitPCI = true, bool InitACPI = true, bool initScrollWheel = true, bool initPS2 = true, bool initNetwork = true, bool ideInit = true, bool serialInit = true)
        {
            ...
            HAL.Global.Init(textScreen, InitPCI, InitACPI, initScrollWheel, initPS2, initNetwork, ideInit, serialInit);
