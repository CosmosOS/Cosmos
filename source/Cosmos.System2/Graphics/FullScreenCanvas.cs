...
public static class FullScreenCanvas
{
    ...
    ///     SVGA 2 device.
    /// </summary>
    private static readonly PCIDevice _SVGAIIDevice = PCI.GetDevice(VendorID.VMWare, DeviceID.SVGAIIAdapter);

    /// <summary>
    ///     Video driver.
    /// </summary>
    private static Canvas _VideoDriver;
    ...
    /// </summary>
    /// <returns></returns>
    public static bool BGAExists() => VBEDriver.ISAModeAvailable();
