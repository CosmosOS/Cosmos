...
namespace Cosmos.System.Graphics
{
    ...
    public class Bitmap : Image
    {
        ...
        private void CreateBitmap(Stream stream, ColorOrder colorOrder)
        {
            ...
            if (infoHeaderSize != 40 && infoHeaderSize != 56 && infoHeaderSize != 124) // 124 - is BITMAPV5HEADER, 56 - is BITMAPV3INFOHEADER, where we ignore the additional values see https://web.archive.org/web/20150127132443/https://forums.adobe.com/message/3272950
            {
