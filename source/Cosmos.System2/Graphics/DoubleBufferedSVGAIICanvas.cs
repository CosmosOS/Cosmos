...
namespace Cosmos.System.Graphics
{
    ...
    /// </summary>
    public class DoubleBufferedSVGAIICanvas : Canvas
    {
        /// <summary>
        ...
        /// </summary>
        private readonly DoubleBufferedVMWareSVGAII _xSVGADriver;

        /// <summary>
        /// Create new instance of the <see cref="DoubleBufferedSVGAIICanvas"/> class.
        /// </summary>
        /// <exception cref="ArgumentOutOfRangeException">Thrown if default graphics mode is not suppoted.</exception>
        public DoubleBufferedSVGAIICanvas()
            : this(_DefaultMode)
        {
        }
        ...
        public DoubleBufferedSVGAIICanvas(Mode aMode)
        {
