...
public class VGACanvas : Canvas
{
    ...
    public VGACanvas()
    {
        ...
        _VGADriver = new VGADriver();
        _VGADriver.SetGraphicsMode(ModeToScreenSize(DefaultGraphicMode),
            (VGADriver.ColorDepth)(int)DefaultGraphicMode.ColorDepth);
    }
    ...
    /// </summary>
    public override Mode DefaultGraphicMode => new(640, 480, ColorDepth.ColorDepth4);
    ...
    /// <param name="aPoint"></param>
    /// <param name="aRadius"></param>
    public override void DrawCircle(Pen aPen, Point aPoint, int aRadius) => base.DrawCircle(aPen, aPoint, aRadius);
    ...
    public override void DrawFilledRectangle(Pen aPen, int aXStart, int aYStart, int aWidth, int aHeight) =>
        _VGADriver.DrawFilledRectangle(aXStart, aYStart, aWidth, aHeight,
            _VGADriver.GetClosestColorInPalette(aPen.Color));
    ...
    /// <param name="aX"></param>
    /// <param name="aY"></param>
    public override void DrawPoint(Pen aPen, int aX, int aY) => _VGADriver.SetPixel((uint)aX, (uint)aY, aPen.Color);
    ...
    /// <param name="aX"></param>
    /// <param name="aY"></param>
    public void DrawPoint(uint aColor, int aX, int aY) => _VGADriver.SetPixel((uint)aX, (uint)aY, aColor);
    ...
    /// <param name="aX"></param>
    /// <param name="aY"></param>
    public override void DrawPoint(Pen aPen, float aX, float aY) => throw new NotImplementedException();
    ...
    public override void DrawPolygon(Pen aPen, params Point[] aPoints) => base.DrawPolygon(aPen, aPoints);
    ...
    public override void DrawSquare(Pen aPen, Point aPoint, int aSize) => base.DrawSquare(aPen, aPoint, aSize);
    ...
    /// <param name="aY"></param>
    /// <param name="aSize"></param>
    public override void DrawSquare(Pen aPen, int aX, int aY, int aSize) => base.DrawSquare(aPen, aX, aY, aSize);
    ...
    /// <param name="aY"></param>
    /// <returns></returns>
    public override Color GetPointColor(int aX, int aY) => Color.FromArgb((int)_VGADriver.GetPixel((uint)aX, (uint)aY));
    ...
    private ScreenSize ModeToScreenSize(Mode aMode)
    {
        ...
        if (aMode.Columns == 640 && aMode.Rows == 480)
        {
            return ScreenSize.Size640x480;
        }

        if (aMode.Columns == 720 && aMode.Rows == 480)
        {
