...
namespace CosmosKernel5.Maps
{
    ...
    /// </summary>
    public class ES_Standard : ScanMapBase
    {
        /// <summary>
        /// Create new instance of the <see cref="ES_Standard"/> class.
        /// </summary>
        public ES_Standard()
        {
        }
        ...
        protected override void InitKeys()
        {
            ...
            _keys.Add(new KeyMapping(0x03, '2', '"', '2', '2', '"', '"', '@', ConsoleKeyEx.D2));
            ...
            _keys.Add(new KeyMapping(0x27, 'ñ', 'Ñ', 'ñ', 'Ñ', 'ñ', 'Ñ', ConsoleKeyEx.Semicolon));
            _keys.Add(new KeyMapping(0x28, '´', '¨', '´', '´', '¨', '¨', '{', ConsoleKeyEx.Apostrophe));
            _keys.Add(new KeyMapping(0x29, 'º', 'ª', 'º', 'º', 'ª', 'ª', '\\', ConsoleKeyEx.Backquote));
            /* Left Shift*/
            _keys.Add(new KeyMapping(0x2A, ConsoleKeyEx.LShift));
            /* \ZXCVBNM,./ */
            _keys.Add(new KeyMapping(0x2B, 'ç', 'Ç', 'ç', 'Ç', 'ç', 'Ç', '}', ConsoleKeyEx.Backslash));
