...
public class KeyMapping
{
    ...
    public KeyMapping(byte aScanCode, char norm, char shift, char num, char caps, char shiftcaps, char shiftnum,
        char altgr, char shiftaltgr, char ctrl, char shiftctrl, ConsoleKeyEx aKey, ConsoleKeyEx numKey)
    {
        Scancode = aScanCode;
        Value = norm;
        Shift = shift;
    ...
    /// <param name="numKey">NumLock key.</param>
    public KeyMapping(byte aScanCode, char norm, char shift, char num, char caps, char shiftcaps, char shiftnum,
        char altgr, char shiftaltgr, ConsoleKeyEx aKey, ConsoleKeyEx numKey)
    ...
    /// <param name="numKey">NumLock key.</param>
    public KeyMapping(byte aScanCode, char norm, char shift, char num, char caps, char shiftcaps, char shiftnum,
        char altgr, ConsoleKeyEx aKey, ConsoleKeyEx numKey)
    ...
    /// <param name="aKey">A key.</param>
    public KeyMapping(byte aScanCode, char norm, char shift, char num, char caps, char shiftcaps, char shiftnum,
        char altgr, char shiftaltgr, char ctrl, char shiftctrl, ConsoleKeyEx aKey)
    ...
    /// <param name="aKey">A key.</param>
    public KeyMapping(byte aScanCode, char norm, char shift, char num, char caps, char shiftcaps, char shiftnum,
        char altgr, char shiftaltgr, ConsoleKeyEx aKey)
    ...
    /// <param name="numKey">NumLock key.</param>
    public KeyMapping(byte aScanCode, char norm, char shift, char num, char caps, char shiftcaps, char shiftnum,
        ConsoleKeyEx aKey, ConsoleKeyEx numKey)
    ...
    /// <param name="shiftnum">Shift and Num</param>
    /// <param name="aKey">A key.</param>
    public KeyMapping(byte aScanCode, int norm, int shift, int num, int caps, int shiftcaps, int shiftnum,
        ConsoleKeyEx aKey)
