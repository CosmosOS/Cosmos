...
namespace Cosmos.System_Plugs.System.Linq
{
    [Plug(Target = typeof(Enumerable))]
    public static class EnumerableImpl
    {
        ...
        public interface IIListProvider<T>
        {
            // Get the count of elements (optional optimization).
            int GetCount(bool onlyIfCheap);

            // Copy items to an array (optional optimization).
            bool TryCopyTo(T[] array, int arrayIndex);
        }
        ...
        class SelectEnumerableIterator<TSource, TResult> : Iterator<TResult>, IIListProvider<TResult>
        {
            ...
            public bool TryCopyTo(TResult[] array, int arrayIndex)
            {
                throw new NotImplementedException();
            }
        }
       ...
       public static IEnumerable<TResult> GroupBy<TSource, TKey, TResult>(this IEnumerable<TSource> source, Func<TSource, TKey> keySelector, Func<TKey, IEnumerable<TSource>, TResult> resultSelector){
        ...
        public static int Sum<TSource>(this IEnumerable<TSource> source, Func<TSource, int> selector) {
            return EnumerableImpl.Sum(EnumerableImpl.Select(source, selector));
        }
        ...
        public static int Min<TSource>(this IEnumerable<TSource> source, Func<TSource, int> selector) {
            return EnumerableImpl.Min(EnumerableImpl.Select(source, selector));
        }
        ...
        public static int Max<TSource>(this IEnumerable<TSource> source, Func<TSource, int> selector) {
            return EnumerableImpl.Max(EnumerableImpl.Select(source, selector));
        }
        ...
        public static double Average<TSource>(this IEnumerable<TSource> source, Func<TSource, int> selector) {
            return EnumerableImpl.Average(EnumerableImpl.Select(source, selector));
        }
