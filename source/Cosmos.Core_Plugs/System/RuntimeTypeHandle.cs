...
public static class RuntimeTypeHandleImpl
{
    ...
    public static bool ContainsGenericVariables(object aRuntimeType) => throw new NotImplementedException();
    ...
    public static int GetToken(object aRuntimeType) => throw new NotImplementedException();

    [PlugMethod(Signature = "System_RuntimeType__System_RuntimeTypeHandle_GetBaseType_System_RuntimeType_")]
    public static object GetBaseType(object aRuntimeType) => throw new NotImplementedException();

    [PlugMethod(Signature = "System_Boolean__System_RuntimeTypeHandle_IsInterface_System_RuntimeType_")]
    public static bool IsInterface(object aRuntimeType) => throw new NotImplementedException();
    ...
    public static IntPtr _GetMetadataImport(object aRuntimeType) => throw new NotImplementedException();
    ...
    public static object GetAssembly(object aRuntimeType) => throw new NotImplementedException();
    ...
    public static void
        GetConstraints(object aQCallTypeHandle, object aTypeNameFormatFlags, object aObjectHandleOnStack) =>
        throw new NotImplementedException();
    ...
    public static bool CanCastTo(object aRuntimeType, object aRuntimeType2) => throw new NotImplementedException();
    ...
    public static bool IsEquivalentTo(object aRuntimeType, object aRuntimeType2) => throw new NotImplementedException();

    [PlugMethod(Signature = "System_Reflection_RuntimeModule__System_RuntimeTypeHandle_GetModule_System_RuntimeType_")]
    public static object GetModule(object aRuntimeType) => throw new NotImplementedException();

    [PlugMethod(Signature = "System_RuntimeType__System_RuntimeTypeHandle_GetDeclaringType_System_RuntimeType_")]
    public static object GetDeclaringType(object aRuntimeType) => throw new NotImplementedException();

    [PlugMethod(Signature = "System_Object__System_RuntimeTypeHandle_Allocate_System_RuntimeType_")]
    public static object Allocate(object aRuntimeType) => throw new NotImplementedException();
    ...
    public static bool IsComObject(object aRuntimeType, bool aBool) => throw new NotImplementedException();
    ...
    public static int GetArrayRank(object aRuntimeType) => throw new NotImplementedException();
