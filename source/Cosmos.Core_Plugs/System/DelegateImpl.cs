...
public static class DelegateImpl
{
    ...
    public static bool Equals(Delegate aThis, object aThat) => throw
...
public static class DelegateImplInherit
{
    ...
    public static unsafe uint InternalAllocLike(uint* aDelegate)
    {
        ...
        xNeededSize += 12;
        var xResultAddr = GCImplementation.AllocNewObject(xNeededSize);
        var xResult = (byte*)xResultAddr;
        var xDelegateAsByte = (byte*)aDelegate;
