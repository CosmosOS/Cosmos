...
using System;
using Cosmos.Core;
using Cosmos.Core_Plugs.MemoryOperations;
...
{
    private static Debugger mDebugger = new("Plug", "Buffer");
    ...
    [PlugMethod(IsOptional = true,
        Signature = "System_Void__System_Buffer___Memmove_System_Byte___System_Byte___System_UIntPtr_")]
    ...
    [PlugMethod(Signature =
        "System_Void__System_Buffer___BulkMoveWithWriteBarrier__System_Byte___System_Byte__System_UIntPtr_")]
