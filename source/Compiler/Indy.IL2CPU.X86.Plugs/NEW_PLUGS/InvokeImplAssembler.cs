...
namespace Indy.IL2CPU.X86.Plugs.NEW_PLUGS {
  public class InvokeImplAssembler: AssemblerMethod {
    ...
    public override void AssembleNew(object aAssembler, object aMethodInfo) {
      ...
      //new CPUx86.Move { DestinationReg = CPUx86.Registers.EAX, SourceReg = CPUx86.Registers.EBP, SourceIsIndirect = true, SourceDisplacement = GetArgumentStartOffset(a MethodInfo.Arguments[0].VirtualAddresses[0] };
