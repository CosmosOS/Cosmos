...
namespace Indy.IL2CPU.IL.X86 {
	public abstract class X86CustomMethodImplementationOp: CustomMethodImplementationOp {
		...
		protected override void Assemble_System_UInt32___Indy_IL2CPU_CustomImplementation_System_StringImpl_GetStorage___System_UInt32___() {
            ...
            //uint xStorageSize;
            //IDictionary<string, TypeInformation.Field> xFields = GetService<IMetaDataInfoService>().GetTypeFieldInfo(typeof (string), out xStorageSize);
		...
		protected override void Assemble_System_Void___System_Array_SetValue___System_Object__System_Int32___(string aCurrentLabel, MethodInformation aCurrentMethodInfo, uint aCurrentOffset, string aNextLabel) {
			// arg 0 == this
			// arg 1 == value
			// arg 2 == index
            //AssembleOp(new Ldarg(MethodInfo, 0));
            ...
            //AssembleOp(new Ldarg(MethodInfo, 1));
            //Stelem_Ref.Assemble(Assembler, 4, GetServiceProvider(), aCurrentLabel, aCurrentMethodInfo, aCurrentOffset, aNextLabel);
		}
