  ...
  public partial class Bochs
  {
    ...
    private void InitializeKeyValues()
    {
      ...
      string default_configuration = "# configuration file generated by Bochs\n"
                                     ...
                                     + "cpuid: mmx=1, apic=xapic, simd=sse2, sse4a=0, misaligned_sse=0, sep=1, movbe=0, adx=0, vendor_string=\"GenuineIntel\", brand_string=\"Intel(R) Pentium(R) 4 CPU\", aes=0, sha=0, xsave=0, xsaveopt=0, x86_64=0, 1g_pages=0, pcid=0, fsgsbase=0, smep=0, smap=0, mwait=1, vmx=1\n"
