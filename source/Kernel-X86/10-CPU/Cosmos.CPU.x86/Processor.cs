...
public class Processor
{
    ...
    public static uint GetAmountOfRAM() => throw new NotImplementedException();

    // needs to be static, as Heap needs it before we can instantiate objects
    [PlugMethod(PlugRequired = true)]
    public static uint GetEndOfKernel() => throw new NotImplementedException();

    [PlugMethod(PlugRequired = true)]
    public void UpdateIDT(bool aEnableInterruptsImmediately) => throw new NotImplementedException();

    [PlugMethod(PlugRequired = true)]
    public void InitFloat() => throw new NotImplementedException();

    [PlugMethod(PlugRequired = true)]
    public void InitSSE() => throw new NotImplementedException();

    [PlugMethod(PlugRequired = true)]
    public static void ZeroFill(uint aStartAddress, uint aLength) => throw new NotImplementedException();
    ...
    private static void DoEnableInterrupts() => throw new NotImplementedException();
