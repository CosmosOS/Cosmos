...
public abstract class IOPortBase
{
    ...
    [PlugMethod(PlugRequired = true)]
    protected static byte Read8(ushort aPort) => 0; // Plugged

    [PlugMethod(PlugRequired = true)]
    protected static ushort Read16(ushort aPort) => 0; // Plugged

    [PlugMethod(PlugRequired = true)]
    protected static uint Read32(ushort aPort) => 0; // Plugged
