...
public class DelegateCtorAsm : AssemblerMethod
{
    public override void AssembleNew(Assembler aAssembler, object aMethodInfo)
    {
        ...
        Stfld.DoExecute(xAssembler, xMethodInfo, "System.Object System.Delegate._target",
            xMethodInfo.MethodBase.DeclaringType, true, false);
        ...
        Stfld.DoExecute(xAssembler, xMethodInfo, "System.IntPtr System.Delegate._methodPtr",
            xMethodInfo.MethodBase.DeclaringType, true, false);
        ...
        {
            returnSize =
                ILOp.Align(ILOp.SizeOfType(xMethodInfo.MethodBase.DeclaringType.GetMethod("Invoke").ReturnType), 4);
        }
