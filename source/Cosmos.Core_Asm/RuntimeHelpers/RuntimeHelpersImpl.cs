...
public static class RuntimeHelpersImpl
{
    ...
    public static void InitializeArray(Array array, RuntimeFieldHandle fldHandle)
    {
        ...
        XS.Push(XSRegisters.EDI, true); // element size
        XS.Add(XSRegisters.EDI, 4);
        XS.Set(XSRegisters.EAX, XSRegisters.EDI, sourceIsIndirect: true);
        XS.Multiply(XSRegisters.ESP, true, size: XSRegisters.RegisterSize.Int32);
        ...
        XS.Set(XSRegisters.EDI, XSRegisters.DL, true);
