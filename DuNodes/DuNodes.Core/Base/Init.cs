...
namespace DuNodes.System.Base
{
    public static class Init
    {
        ...
        {
           DuNodes.System.Console.Console.WriteLine(".Booting DuNodes Alpha 0.1 R01", ConsoleColor.Blue, true);
            DuNodes.System.Console.Console.WriteLine("..Checking prerequisites", ConsoleColor.Blue, true);
