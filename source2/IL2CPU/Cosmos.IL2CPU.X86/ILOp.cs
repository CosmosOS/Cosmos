    ...
    public abstract class ILOp : Cosmos.IL2CPU.ILOp
    {
      protected new readonly Cosmos.Compiler.Assembler.Assembler Assembler;
        ...
        protected static List<IL.FieldInfo> GetFieldsInfo(Type aType)
        {
            ...
            List<DebugInfo.Field_Info> xDebugInfs = new List<DebugInfo.Field_Info>();
            foreach (var xInfo in xResult)
            {
                xDebugInfs.Add(new Debug.Common.DebugInfo.Field_Info
                {
        ...
        private static void GetFieldMapping(List<IL.FieldInfo> aFieldInfs, List<DebugInfo.Field_Map> aFieldMapping, Type aType)
        {
        ...
        private static string GetNameForField(IL.FieldInfo inf)
        {
