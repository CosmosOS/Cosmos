...
namespace DebugCompiler
{
  class Program
  {
    public const string OutputRoot = @"C:\Users\Huge\Documents\Visual Studio 2010\Projects\IL2CPU";
    ...
    //      xTask.DebugCom = 1;
    //      xTask.UseNAsm = true;
    //      xTask.OutputFilename = OutputRoot + @"\source2\users\Matthijs\Playground\bin\Debug\PlaygroundBoot.asm";
    ...
    static void Main() {
        var di = new DebugInfo(@"C:\Users\Huge\Documents\Visual Studio 2010\Projects\IL2CPU\source2\Demos\Guess\bin\Debug\Guess.cdb");
        di.LoadLookups();
    }
    ...
    private static ITaskItem[] GetReferences()
    {
      return new ITaskItem[]{
        new TaskItemImpl(OutputRoot + @"\source2\Users\Matthijs\Playground\bin\Debug\Playground.dll"),
        new TaskItemImpl(OutputRoot + @"\source2\Kernel\System\Hardware\Core\Cosmos.Core.Plugs\bin\x86\Debug\Cosmos.Core.Plugs.dll"),
        new TaskItemImpl(OutputRoot + @"\source2\Kernel\Debug\Cosmos.Debug.Kernel.Plugs\bin\x86\Debug\Cosmos.Debug.Kernel.Plugs.dll"),
        new TaskItemImpl(OutputRoot + @"\source2\Kernel\System\Cosmos.System.Plugs.System\bin\x86\Debug\Cosmos.System.Plugs.System.dll")
      };
    }
