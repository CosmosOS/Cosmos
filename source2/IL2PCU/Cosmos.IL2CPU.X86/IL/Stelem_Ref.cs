...
namespace Cosmos.IL2CPU.X86.IL
{
    ...
    public class Stelem_Ref : ILOp
    {
        ...
        //public static void Assemble( Assembler aAssembler, uint aElementSize, IServiceProvider aServiceProvider, string aCurrentLabel, MethodInformation aCurrentMethodInfo, uint aCurrentOffset, string aNextLabel )
        //{
        //    // stack - 3 == the array
        //    // stack - 2 == the index
