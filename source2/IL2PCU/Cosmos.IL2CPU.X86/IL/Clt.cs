        ...
        public override void Execute( MethodInfo aMethod, ILOpCode aOpCode )
        {
            ...
            if( xStackItem.Size > 4 )
            {
                if (xStackItem.IsFloat)
                {
                    ...
                    new CPUx86.Add { DestinationReg = CPUx86.Registers.ESP, SourceValue = 4 };
                    new CPUx86.SSE.MoveSS { DestinationReg = CPUx86.Registers.XMM6, SourceReg = CPUx86.Registers.ESP, SourceIsIndirect = true };
                    new CPUx86.Add { DestinationReg = CPUx86.Registers.ESP, SourceValue = 4 };
                    new CPUx86.SSE.MoveSS { DestinationReg = CPUx86.Registers.XMM7, SourceReg = CPUx86.Registers.ESP, SourceIsIndirect = true };
                    new CPUx86.Add { DestinationReg = CPUx86.Registers.ESP, SourceValue = 4 };
                    new CPUx86.SSE.SubSS { DestinationReg = CPUx86.Registers.XMM6, SourceReg = CPUx86.Registers.XMM2 };
                    new CPUx86.SSE.SubSS { DestinationReg = CPUx86.Registers.XMM7, SourceReg = CPUx86.Registers.XMM3 };
                    ...
                    new CPUx86.SSE.SubSS { DestinationReg = CPUx86.Registers.XMM7, SourceReg = CPUx86.Registers.XMM2 };
                }
                else
                {
