...
//            string xXml = Cosmos.Build.MSBuild.IL2CPU_Old.base64Decode(args[0]);
...
//                xSearchDirs.Add(Path.GetDirectoryName(typeof(Cosmos.Build.MSBuild.IL2CPU_Old).Assembly.Location));
